...
df_assignment_round1 <- read.table("/Users/jbl/Documents/UW/Data/sequencing_runs/seq075_SP_10x_shuffle_BC_revision_20240831/assignment_cell_to_clonotype_Lane2_round1/FINAL_round1_assignment_cells_to_denovo3umi_Lane2_w_remap_20240919.txt",
                                   header=TRUE)
...
ggplot(df_BC_pairs_sum_UMI) + stat_bin(aes(x=sum_UMI,color=CS1_BC %in% large_clone_BC_excluded_v3),geom="step")+
  scale_x_log10()+scale_y_log10()+
...
for (cluster_oi in seurat_clusters){
  ...
  # core_pBC_plot
  fig_name <- sprintf("/Users/jbl/Documents/UW/Data/sequencing_runs/seq075_SP_10x_shuffle_BC_revision_20240831/clonotype_calling_Lane2_round2/cluster_UMAP_w_distribution_T7BC_representation_per_cell_3umi/clusters_T7BCs_Lane2_round2_id_%d_20240920.pdf",
                      cluster_oi)
...
list_core_T7BC2 <- list_core_T7BC[max_frac_per_cluster>0.5 & MOI_per_cluster>=3]
...
for (cluster_oi in seurat_clusters){
  ...
  if (length(list_core_T7BC2[[as.character(cluster_oi)]])>1){
    ...
    # core_pBC_plot
    fig_name <- sprintf("/Users/jbl/Documents/UW/Data/sequencing_runs/seq075_SP_10x_shuffle_BC_revision_20240831/clonotype_calling_Lane2_round2/heatmap_T7BC_count_across_assigned_cells_3umi/heatmap_T7BC_counts_Lane2_round2_cluster_%d_20240920.pdf",
                        cluster_oi)
...
df_round1_clonotypes <- read.table("/Users/jbl/Documents/UW/Data/sequencing_runs/seq075_SP_10x_shuffle_BC_revision_20240831/clonotype_calling_Lane2_round1/denovo_clonotypes_round1_Lane2_3umi_table_CS1_BC_large_clone_separate_20240919.txt",
                                   header=TRUE)

list_core_T7BC2_round1 <- split(df_round1_clonotypes$CS1_BC,df_round1_clonotypes$consensus_clone_id)

round2_addition <- list_core_T7BC2["0"]

names(round2_addition) <- "0_round2"
