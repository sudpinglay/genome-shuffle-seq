...
for (cluster_oi in seurat_clusters){
  ...
  # core_pBC_plot
  fig_name <- sprintf("%s/clusters_T7BCs_id_iteration_wo_large_clones_CS1_BC_only_%d_20240919.pdf",
                      dir_out,
                      cluster_oi)
...
list_core_T7BC2 <- list_core_T7BC[max_frac_per_cluster>0.55 & MOI_per_cluster>=2]
...
for (cluster_oi in seurat_clusters){
  ...
  if (length(list_core_T7BC2[[as.character(cluster_oi)]])>1){
    ...
    # core_pBC_plot
    fig_name <- sprintf("/Users/jbl/Documents/UW/Data/sequencing_runs/seq075_SP_10x_shuffle_BC_revision_20240831/clonotype_calling/heatmap_T7BC_count_across_assigned_cells_3umi/heatmap_T7BC_counts_cluster_%d_wo_large_CS1_BC_only_20240919.pdf",
                        cluster_oi)
...
write.table(df_consensus_clone_seurat2,"/Users/jbl/Documents/UW/Data/sequencing_runs/seq075_SP_10x_shuffle_BC_revision_20240831/clonotype_calling_Lane2_round1/denovo_clonotypes_round1_Lane2_3umi_table_CS1_BC_large_clone_separate_20240919.txt",
