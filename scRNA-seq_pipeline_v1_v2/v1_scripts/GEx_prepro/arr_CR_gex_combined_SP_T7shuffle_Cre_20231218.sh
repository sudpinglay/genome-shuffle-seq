...
cellranger count --id="sample_Cre_combined_runs_GEx_CRv6_"${date_str} \
	--fastqs=/net/shendure/vol10/projects/JBL/seq055SP_T7_shuffle_10x/nobackup/GEx_fastqs/GEx_Cre,/net/shendure/vol10/projects/JBL/seq055SP_T7_shuffle_10x/nobackup/GEx_fastqs/GEx_CRE_reseq \
