...
for (cluster_oi in seurat_clusters){
  ...
  # core_pBC_plot
  fig_name <- sprintf("/Users/jbl/Documents/UW/Data/sequencing_runs/seq057SP_reprep_T7_BCs_20231206/clonotype_mapping_v2/cluster_UMAP_w_distribution_T7BC_representation_per_cell_3umi/clusters_T7BCs_id_%d_20231220.pdf",
                      cluster_oi)
...
for (cluster_oi in seurat_clusters){
  ...
  if (length(list_core_T7BC2[[as.character(cluster_oi)]])>1){
    ...
    # core_pBC_plot
    fig_name <- sprintf("/Users/jbl/Documents/UW/Data/sequencing_runs/seq057SP_reprep_T7_BCs_20231206/clonotype_mapping_v2/heatmap_T7BC_count_across_assigned_cells_3umi/heatmap_T7BC_counts_cluster_%d_20231220.pdf",
                        cluster_oi)
